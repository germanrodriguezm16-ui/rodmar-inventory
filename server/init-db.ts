...
export async function initializeRolesAndPermissions() {
  ...
  try {
    ...
    const permisosBase = [
      ...
      { key: 'module.MINAS.list.BALANCES.view', descripcion: 'Ver balances en listado de Minas (encabezado y tarjetas)', categoria: 'tab' },
      ...
      { key: 'module.COMPRADORES.list.BALANCES.view', descripcion: 'Ver balances en listado de Compradores (encabezado y tarjetas)', categoria: 'tab' },
      ...
      { key: 'module.VOLQUETEROS.list.BALANCES.view', descripcion: 'Ver balances en listado de Volqueteros (encabezado y tarjetas)', categoria: 'tab' },

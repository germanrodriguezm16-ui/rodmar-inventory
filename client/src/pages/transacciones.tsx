        ...
        <div className="flex items-center justify-between text-sm space-x-4">
          <div className="flex items-center space-x-4">
            <div>
              ...
              <span className="text-green-600 font-medium">{formatCurrency(balanceCalculations.positivos.toString())}</span>
            </div>
            <div>
              <span className="text-muted-foreground">Negativos: </span>
              <span className="text-red-600 font-medium">{formatCurrency(balanceCalculations.negativos.toString())}</span>
            </div>
            <div>
              <span className="text-muted-foreground">Balance: </span>
              <span className={`font-medium ${balanceCalculations.balanceColorClass}`}>
                {formatCurrency(balanceCalculations.balance.toString())}
              </span>
            </div>
          </div>
        </div>
